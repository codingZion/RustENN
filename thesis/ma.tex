...
\begin{figure}[htbp!]
    ...
    % First graph
    \begin{adjustbox}{valign=c,margin=-3cm 0pt 0pt 0pt} % Shift content left by 2cm
    ...
    \renewcommand{\csvpath}{../data/simple_nim/stack_8/t_1/stats.csv} % Rename the macro
            \begin{axis}[
                ...
                \addlegendentry{Best agent performance \%}
                \addplot table [
                x=generation,
                y=best_agent_wins_percentage,
                col sep=comma,
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \renewcommand{\csvpath}{../data/simple_nim/stack_8/t_1.1/stats.csv} % Rename the macro
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \begin{tikzpicture}
            \renewcommand{\csvpath}{../data/simple_nim/stack_8/t_1.2/stats.csv} % Rename the macro
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \begin{tikzpicture}
            \renewcommand{\csvpath}{../data/simple_nim/stack_8/t_1.3/stats.csv} % Rename the macro
...
\setlength{\oddsidemargin}{0pt} % Reset to default
\setlength{\textwidth}{15.5cm} % Reset to default
    ...
    \renewcommand{\csvpath}{../data/simple_nim/stack_8r/t_1.1/stats.csv} % Rename the macro
    \begin{center}
        \begin{tikzpicture}
            \begin{axis} [
                grid=both,
    ...
    In all tests, the NNs got stuck in a local minimum
    
    \subsubsection{Stack 8, Configuration 2}
    To eliminate agents , we will now try to give better performing agents higher chance of reproduction.
    ...
    \begin{center}
        ...
        \end{tikzpicture}
    \end{center}
    The best agent average performance stalls again at 25\%, which means nothing has changed to before.
    ...
    It is also important to note that the other two times I repeated the experiment, the ENN once learned the right move as quickly as in the first test and the other time learned it even faster.
                \subsubsection{Stack: 8, Configuration 3}
    ...
    Only after I changed the output encoding, did the things start to change.
                \subsubsection{Stack 1--8, Configuration 2}
