...
\addlegendentry{\(Sigmoid\)}
    ...
    \begin{tabular}{ || p{8em} c c p{8em} p{5em} p{8em} || }
        \hline
        author(s) & year & model & game/benchmark & computation & accuracy\\
        \hline\hline
        Stanley, Kenneth O. and Miikkulainen, Risto\footcite{neat_02} & 2002 & NEAT & Double Pole Balancing With Velocities & \makecell{3600\\ evaluations} & 100\% \\
        \hline
        Banaz Anwer Qader et al.\footcite{dama_22} & 2022 & NEAT & Dama & \makecell{$>$5000 \\ generations} & 81.25\% (wins against humans)\\
        \hline
        Richards, Norman et al.\footcite{go_98} & 1998 & SANE & Go & \makecell{260 \\ generations} & $>$75\% vs Wally (9$*$9 board)\\
        \hline
