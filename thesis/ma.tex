...
\end{figure}
    ...
    In all tests, the NNs got stuck in a local minimum, where the NN only played the move where it subtracts one match, except for test 2, where it was also able to remove 4 matches:
    \begin{minted}{}
    Agent 999 vs Agent 998:
    ...
    We will therefore try to modify some parameters and look if they can help overcoming that problem.
    ...
    \begin{enumerate}
        ...
        \item Population size set to 10000
        ...
        \begin{adjustbox}{valign=c,margin=-2cm 0pt 0pt 0pt} % Shift content left by 2cm
            \begin{minipage}{1.1\textwidth}
                ...
                \begin{subfigure}[b]{0.45\textwidth}
                    ...
                    \begin{tikzpicture}
                        \begin{axis}[
                            title={New population composition},
                            grid=both,
                            xmin=0, xmax=1000,
                            ymin=0, ymax=150,
                            no markers,
    ...
    However, there is one more thing we can change.
