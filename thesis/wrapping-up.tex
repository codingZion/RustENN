...
\noindent\fbox{%
    \parbox{\textwidth}{%
        Ich, Lucien Kissling, erkläre hiermit, dass ich die vorliegende Arbeit «Evolutionary Neural Networks: Designing a NEAT-Inspired Algorithm for Strategic Game Learning» selbststaendig und ohne Benützung anderer als der angegebenen Quellen oder Hilfsmittel verfasst bzw. gestaltet habe.
        \\
        \vspace{1em}
        Ort, Datum: \underline{\hspace{3cm}} \hfill Unterschrift: \underline{\hspace{3cm}}
    }%
}
%}}
